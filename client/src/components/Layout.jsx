    ...
    return (
        <div className="flex h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
            ...
            <main className="flex-1 overflow-auto w-full flex flex-col">
                {/* Desktop Top Header */}
                <header className="h-16 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 hidden md:flex items-center justify-between px-8 sticky top-0 z-30">
                    <div className="flex items-center gap-4">
                        {/* Title or Breadcrumbs could go here */}
                    </div>
                    <div className="flex items-center gap-6">
                        {/* Global USD Rate Toggle Removed */}
                ...
                <header className="h-16 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between px-6 md:hidden sticky top-0 z-30 transition-colors duration-200">
                    ...
                    <div className="flex items-center gap-2">
                        {/* Mobile Currency Display Removed */}
                        <button
                            onClick={toggleTheme}
                            className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 transition-colors"
                        >
